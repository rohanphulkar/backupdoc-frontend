  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'custom-dashboard': '0 10px 30px rgba(0, 0, 0, 0.5)',
        'custom-dashboard-hover': '0 15px 40px rgba(0, 0, 0, 0.6)',
        'rounded-custom': '0 10px 30px rgba(0, 0, 0, 0.5)',
      },
      ...
      // Add custom colors for light and dark modes
      colors: {
        light: {
          background: '#f0f4f8', // Light background color
          text: '#333', // Light text color
        },
        dark: {
          background: '#310b37', // Dark background color
